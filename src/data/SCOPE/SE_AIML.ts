export const SE_AIML = {
  'BCSE209L - Machine Learning': [
    { slot: 'A1+TA1', venue: 'SJT601', faculty: 'AARTHY S.L' },
  ],
  'BCSE209P - Machine Learning Lab': [
    { slot: 'L57+L58', venue: 'SJT517', faculty: 'AARTHY S.L' },
  ],
  ...
  'BCSE417L - Machine Vision': [
    { slot: 'B1+TB1', venue: 'SJT601', faculty: 'AJU D' },
  ],
  'BCSE417P - Machine Vision Lab': [
    { slot: 'L37+L38', venue: 'SJT319', faculty: 'AJU D' },
  ],
