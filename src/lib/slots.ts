import { slot } from "@/components/timetable/type";
...
const slotMap: Record<string, slot[]> = {
    ...
    'L1+L2': [{ rowStart: 5, rowEnd: 6, colStart: 2, colEnd: 12, slotName: 'L1+L2' }],
    'L3+L4': [{ rowStart: 5, rowEnd: 6, colStart: 13, colEnd: 23, slotName: 'L3+L4' }],
    'L5+L6': [{ rowStart: 5, rowEnd: 6, colStart: 24, colEnd: 34, slotName: 'L5+L6' }],
    'L7+L8': [{ rowStart: 8, rowEnd: 9, colStart: 2, colEnd: 12, slotName: 'L7+L8' }],
    'L9+L10': [{ rowStart: 8, rowEnd: 9, colStart: 13, colEnd: 23, slotName: 'L9+L10' }],
    'L11+L12': [{ rowStart: 8, rowEnd: 9, colStart: 24, colEnd: 34, slotName: 'L11+L12' }],
    'L13+L14': [{ rowStart: 11, rowEnd: 12, colStart: 2, colEnd: 12, slotName: 'L13+L14' }],
    'L15+L16': [{ rowStart: 11, rowEnd: 12, colStart: 13, colEnd: 23, slotName: 'L15+L16' }],
    'L17+L18': [{ rowStart: 11, rowEnd: 12, colStart: 24, colEnd: 34, slotName: 'L17+L18' }],
    'L19+L20': [{ rowStart: 14, rowEnd: 15, colStart: 2, colEnd: 12, slotName: 'L19+L20' }],
    'L21+L22': [{ rowStart: 14, rowEnd: 15, colStart: 13, colEnd: 23, slotName: 'L21+L22' }],
    'L23+L24': [{ rowStart: 14, rowEnd: 15, colStart: 24, colEnd: 34, slotName: 'L23+L24' }],
    'L25+L26': [{ rowStart: 17, rowEnd: 18, colStart: 2, colEnd: 12, slotName: 'L25+L26' }],
    'L27+L28': [{ rowStart: 17, rowEnd: 18, colStart: 13, colEnd: 23, slotName: 'L27+L28' }],
    'L29+L30': [{ rowStart: 17, rowEnd: 18, colStart: 24, colEnd: 34, slotName: 'L29+L30' }],

    'L31+L32': [{ rowStart: 5, rowEnd: 6, colStart: 38, colEnd: 48, slotName: 'L31+L32' }],
    'L33+L34': [{ rowStart: 5, rowEnd: 6, colStart: 49, colEnd: 59, slotName: 'L33+L34' }],
    'L35+L36': [{ rowStart: 5, rowEnd: 6, colStart: 60, colEnd: 70, slotName: 'L35+L36' }],
    'L37+L38': [{ rowStart: 8, rowEnd: 9, colStart: 38, colEnd: 48, slotName: 'L37+L38' }],
    'L39+L40': [{ rowStart: 8, rowEnd: 9, colStart: 49, colEnd: 59, slotName: 'L39+L40' }],
    'L41+L42': [{ rowStart: 8, rowEnd: 9, colStart: 60, colEnd: 70, slotName: 'L41+L42' }],
    'L43+L44': [{ rowStart: 11, rowEnd: 12, colStart: 38, colEnd: 48, slotName: 'L43+L44' }],
    'L45+L46': [{ rowStart: 11, rowEnd: 12, colStart: 49, colEnd: 59, slotName: 'L45+L46' }],
    'L47+L48': [{ rowStart: 11, rowEnd: 12, colStart: 60, colEnd: 70, slotName: 'L47+L48' }],
    'L49+L50': [{ rowStart: 14, rowEnd: 15, colStart: 38, colEnd: 48, slotName: 'L49+L50' }],
    'L51+L52': [{ rowStart: 14, rowEnd: 15, colStart: 49, colEnd: 59, slotName: 'L51+L52' }],
    'L53+L54': [{ rowStart: 14, rowEnd: 15, colStart: 60, colEnd: 70, slotName: 'L53+L54' }],
    'L55+L56': [{ rowStart: 17, rowEnd: 18, colStart: 38, colEnd: 48, slotName: 'L55+L56' }],
    'L57+L58': [{ rowStart: 17, rowEnd: 18, colStart: 49, colEnd: 59, slotName: 'L57+L58' }],
    'L59+L60': [{ rowStart: 17, rowEnd: 18, colStart: 60, colEnd: 70, slotName: 'L59+L60' }],
};
